...
class FutureAppointmentList extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    FutureAppointmentProvider appointmentProvider =
        Provider.of<FutureAppointmentProvider>(context);
    return appointmentProvider.status == futureStatus.loading
        ? Loading()
